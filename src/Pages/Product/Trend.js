...
import { exploreProducts, getAllProducts, getProducts, getTrendProducts } from '../../store/product-slice';
        ...
        <div className='first-div' >
         ...
         {products && products.length > 0 ?products.map((element)=>{
          return (
            ...
            <div className='img' style={{ background: `url(${"https://symloop.com"+element.images[0].name})`, backgroundSize: '100% 100% ', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}></div>
